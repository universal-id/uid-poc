...
namespace OnlineService.Data
{
    ...
    public partial class Repository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        /// </summary>
        /// <param name="entity">Entity</param>
        public virtual async Task<T> UpdateAsync(T entity, bool isUpsert = true)
        {
            await _collection.ReplaceOneAsync(x => x.Id == entity.Id, entity, new ReplaceOptions() { IsUpsert = isUpsert });
            return entity;
        }
